...
namespace CL.BS.NotionsVM.VM.Sentences
{
    ...
    #endregion MEF
    public class DailyWordsVM : BaseSentences, IPageVM
    {        
        public override string Name => "DailyWordsVM";
        public DailyWordsVM()
        {
           
        }
      protected override void SetBackground() { 
            BackgroundPic = string.Format(@"{0}Resources\Notions\Sentences\DailyWords{1}.jpg",
