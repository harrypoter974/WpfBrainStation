...
namespace CL.BS.NotionsVM.VM.Sentences
{
    ...
    #endregion MEF
    public class MorningVM : BaseSentences, IPageVM
    {
        public override string Name => "MorningVM";
        public MorningVM()
        {
        }
        ...
        {
            BackgroundPic = string.Format(@"{0}Resources\Notions\Sentences\Morning{1}.jpg",
