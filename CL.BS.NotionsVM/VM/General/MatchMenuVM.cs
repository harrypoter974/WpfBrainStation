...
namespace CL.BS.NotionsVM.VM.General
{
    ...
    #endregion MEF
    public class MatchMenuVM : VMCommon.BaseLernPage, IPageVM
    {
        public override string Name
        {
            get
            {
                return nameof(MatchMenuVM) ;
            }
        }
 ...
 SupportHandlerManager.Base.GetManager("IMathMatchManager");
        ...
        private void DoSetLevel(object obj)
        {
            ...
            {
                _isCompetitive = 4 == i;
                IsCompetitiveBut = _isCompetitive ? string.Format(@"{0}Resources\BS.Items\Hard.png", System.AppDomain.CurrentDomain.BaseDirectory) : string.Empty;
