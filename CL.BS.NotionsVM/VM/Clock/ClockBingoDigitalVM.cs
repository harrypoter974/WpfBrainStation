...
namespace CL.BS.NotionsVM.VM.Clock
{
    ...
    #endregion MEF
    public class ClockBingoDigitalVM : BaseAutoGameVM, IPageVM
    {
        ...
        public override string Name
        {
            get
            {
                return nameof(ClockBingoDigitalVM);
            }
        }

        public ClockBingoDigitalVM()
        {
...
SupportHandlerManager.Base.GetManager("ClockBingoManager");
            ...
            for (int i = 0; i < Boards.Length; i++) {
                Boards[i] = new ClockBingoDigitalBoardVM();
            }
            Timer = "9";
            TimerIndex = 2;
            BoardWidth = System.Windows.SystemParameters.PrimaryScreenWidth* 0.38;
