...
namespace CL.BS.EnglishManager.Engen.Words
{
    ...
    {
        internal String GetWord(string syllable,object i)
        {
            int index = int.Parse(i.ToString());
            string path = string.Empty;
            switch (syllable)
            {
                case "ba": path = new string[] { "Opposites\\Bad", "Animals\\Bat", "Fruit\\Banana" }[index]; break;
                case "ca": path = new string[] { "Syllable\\can",  "Animals\\Cat","" }[index]; break;
                ...
                case "le": path = new string[] { "Syllable\\leg", "Fruit\\Lemon", "Letters\\Letters" }[index]; break;
                ...
                case "li": path = new string[] { "Syllable\\lid", "Body\\lips", "" }[index]; break;
                case "pi": path = new string[] { "Syllable\\pin", "Syllable\\pill", "OpeningLetter\\Pizza" }[index]; break;

                case "bo": path = new string[] { "Syllable\\Box", "Body\\Body", "" }[index]; break;
                ...
                case "bu": path = new string[] { "Syllable\\Bug", "Vehicles\\Bus", "" }[index]; break;
