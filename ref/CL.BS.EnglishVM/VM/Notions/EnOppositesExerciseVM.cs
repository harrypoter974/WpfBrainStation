...
namespace CL.BS.EnglishVM.Notions
{
    ...
    #endregion MEF
    public class EnOppositesExerciseVM : BaseStepVM, IPageVM
    {
        public EnOppositesExerciseVM()
        {
            ...
            BackgroundPic = System.AppDomain.CurrentDomain.BaseDirectory +
                @"Resources\Languages\English\Opposites\x0.jpg";
        ...
        private void DoSwichPage(object index)
        {
            ...
            BackgroundPic = System.AppDomain.CurrentDomain.BaseDirectory +
                 @"Resources\Languages\English\Opposites\x" + index + ".jpg";
            NotifyPropertyChanged("BackgroundPic");
