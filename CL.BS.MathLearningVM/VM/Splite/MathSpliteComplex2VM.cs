...
namespace CL.BS.MathLearningVM.Splite
{
    ...
    #endregion MEF
    public class MathSpliteComplex2VM : MathComplexVM, IPageVM
    {
        public override string Name => nameof(MathSpliteComplex2VM);

        public MathSpliteComplex2VM()
        {
...
SupportHandlerManager.Base.GetManager("MathSpliteComplexManager");
        ...
        void IPageVM.load()
        {
            ...
            _logic.SetLevel(1);
            TBTitle = string.Format(@"{0}Resources\Math\Exercise\SpliteComplex.jpg",
