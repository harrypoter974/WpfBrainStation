...
namespace CL.BS.MathLearningVM.Sub
{
    ...
    #endregion MEF
    public class MathSubComplex2VM : MathComplexVM, IPageVM
    {
        public override string Name => nameof(MathSubComplex2VM);

        public MathSubComplex2VM()
        {
            _logic = (IMathComplexManager)
 SupportHandlerManager.Base.GetManager("MathSubComplexManager");
        ...
        void IPageVM.load()
        {
            ...
            _logic.SetLevel(1);
            TBTitle = string.Format(@"{0}Resources\Math\Exercise\SubComplex.jpg",
