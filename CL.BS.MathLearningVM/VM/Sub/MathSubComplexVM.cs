...
namespace CL.BS.MathLearningVM.Sub
{
    ...
    #endregion MEF
    public class MathSubComplexVM : MathComplexVM, IPageVM
    {
        public override string Name =>nameof(MathSubComplexVM) ;

        public MathSubComplexVM()
        {
...
SupportHandlerManager.Base.GetManager("MathSubComplexManager");
        ...
        void IPageVM.load()
        {
            ...
            _logic.SetLevel(0);
            TBTitle = string.Format(@"{0}Resources\Math\Exercise\Sub.jpg",
