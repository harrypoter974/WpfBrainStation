...
namespace CL.BS.MathLearningVM.Sub
{
    ...
    #endregion MEF
    public class MathSubFracture2VM : MathComplexVM, IPageVM
    {
        public override string Name => nameof(MathSubFracture2VM);
        public MathSubFracture2VM() {
            ...
            TBTitle = System.AppDomain.CurrentDomain.BaseDirectory
                       + @"Resources\Math\Exercise\SubFracture.jpg";
