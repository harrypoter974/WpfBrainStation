...
namespace CL.BS.MathLearningVM.Add
{
    ...
    #endregion MEF
    public class MathAddComplex2VM : MathComplexVM, IPageVM
    {
        public override string Name => nameof(MathAddComplex2VM);
        public MathAddComplex2VM()
        {
        ...
        void IPageVM.load()
        {
            ...
            _logic.SetLevel(1);
            TBTitle = string.Format(@"{0}Resources\Math\Exercise\AddComplex.jpg",
