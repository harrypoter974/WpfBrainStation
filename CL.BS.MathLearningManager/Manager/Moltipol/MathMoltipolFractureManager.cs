...
namespace CL.BS.MathLearningManager.Manager.Moltipol
{
    ...
    #endregion MEF
    public class MathMoltipolFractureManager : IManager, IMathFractureManager, IMathComplexManager
    {
        string IManager.ManagerName => "MathMoltipolFractureManager";
        private MathMoltipolFractureEngine _logic = new MathMoltipolFractureEngine();
