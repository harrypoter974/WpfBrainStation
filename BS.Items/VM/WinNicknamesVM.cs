...
namespace BS.Items.VM
{
    class WinNicknamesVM : BaseMenuVM
    {
        ...
        protected ViewObject[] LetterList = new ViewObject[CL.BS.Common.StaticVar.HeLetersList.Length - 5];
        ...
        public WinNicknamesVM(MouseSplitter win)
        {
            ...
            {
                LetterList[i] = new ViewObject { Letter = CL.BS.Common.StaticVar.HeLetersList[i] };
            }
      ...
      "Resources\\BS.Items\\GirlTitle.jpg";
        ...
        private void DoSelectLetter(object letter)
        {
            ...
            for (int i = 0; i < LetterList.Length; i++)
            {
                if (LetterList[i].Uid == _preLetter[0])
                {
        ...
        private void DoSelectName(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            NotifyPropertyChanged("TextName"+ this._win.currentMouse.Rotation);
