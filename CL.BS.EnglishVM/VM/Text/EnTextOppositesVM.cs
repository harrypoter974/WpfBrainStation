...
namespace CL.BS.EnglishVM.Text
{
    ...
    #endregion MEF
    public class  EnTextOppositesVM: BaseTextVM,  IPageVM
    {
        public override string Name
        {
            get
            {
                return nameof(EnTextOppositesVM);
            }
        }
        private IEnTextOppositesManager _logic = (IEnTextOppositesManager)
   SupportHandlerManager.Base.GetManager("EnTextOppositesManager");

        public EnTextOppositesVM()
        {
        ...
        private void DoChangeWord(object obj)
        {
            ...
            PicBackground = System.AppDomain.CurrentDomain.BaseDirectory +
               @"Resources\Lang\En\Opposites\writing" + obj + ".jpg";
