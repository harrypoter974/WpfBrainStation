...
{
    public partial class UCWinCheckers : UserControl
    {
        public UCWinCheckers()
        {
            InitializeComponent();
        ...
        {
            PictureBoxGameTool middlePictureBox = pictureBoxMatrix[0, (8 / 2) - 1];
        ...
        {
            labelPlayer1.Text = string.Format("{0}: {1}", "שחקן 1", i_Player1Score);
            labelPlayer2.Text = string.Format("{0}: {1}", "שחקן 2", i_Player2Score);
        }

        private void setFormBoarders()
        {
            this.Size = new Size((8 * k_PictureBoxWidth) + k_WidthExtention, (8 * k_PictureBoxHeight) + k_HeightExtention);
        }
        ...
        {
            Point newLocation;
            int pictureBoxMatrixMaxLine =8 - 1;
            int pictureBoxMatrixMaxCol = 8 - 1;
