...
namespace CL.BS.ShapesVM.VM.Exercise
{
    ...
    #endregion MEF
    public class BoardAreaVM : BaseBoardShape, IPageVM
    {
        public string NumText { get; set; }
        private Common.GeneralFunctions _logic = new Common.GeneralFunctions(); 
        private string[] _AnswerList = new string[] { "96", "66", "100","64" };
        public BoardAreaVM()
        {
            ...
            BackgroundPic = string.Format(@"{0}Resources\Shapes\Area\a.png"
, System.AppDomain.CurrentDomain.BaseDirectory);
        ...
        private void DoAnswerBut(object obj)
        {
            if (base.IsQuestionMode)
            {
                ...
                BackgroundPic = string.Format(@"{0}Resources\Shapes\Area\a{1}.png"
