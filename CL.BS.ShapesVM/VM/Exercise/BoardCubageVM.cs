...
namespace CL.BS.ShapesVM.VM.Exercise
{
    ...
    #endregion MEF
    public class BoardCubageVM : BaseBoardShape, IPageVM
    {
        public string NumText { get; set; }
        private Common.GeneralFunctions _logic = new Common.GeneralFunctions();
        private string[] _AnswerList = new string[] { "216", "105", "200", "125" };
        public BoardCubageVM()
        {
            ...
            BackgroundPic = string.Format(@"{0}Resources\Shapes\Cubage\c.png"
, System.AppDomain.CurrentDomain.BaseDirectory);
        ...
        private void DoAnswerBut(object obj)
        {
            if (base.IsQuestionMode)
            {
                ...
                BackgroundPic = string.Format(@"{0}Resources\Shapes\Cubage\c{1}.png"
